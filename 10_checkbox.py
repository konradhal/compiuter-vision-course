...
img = cv2.imread(r'D:\Programy\pyCharm\compiuter-vision-course1\01_basics\assets\checkbox.png')
# cv2.imshow('img', img)
...
img_cnt = cv2.drawContours(image=img.copy(), contours=[contours[2]],contourIdx=-1, color=(0, 255, 0), thickness=2)
