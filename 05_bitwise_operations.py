...
image = cv2.imread(r'D:\Programy\pyCharm\compiuter-vision-course1\01_basics\assets\view.jpg')
logo = cv2.imread(r'images\D:\Programy\pyCharm\compiuter-vision-course1\01_basics\assets\python.png')
